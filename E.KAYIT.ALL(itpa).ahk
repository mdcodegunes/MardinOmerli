...
::hnaa,:: ;;
myFuncHasta("HANİMİ AKKOÇ", "YEŞİLLİ", 5424195947, "GTM", "YARI BAĞIMLI", "YAŞLILIK", 87, 64792007982,"GÜL Mahallesi, DEĞİRMENLER CADDESİ YEŞİL SOKAK NO.7 ,YEŞİLLİ / MARDİN")
Return
::hnak,::
...
;;46168684430
::aöa,:: ;;
myFuncHasta("AHMET ÖLKER", "ÖMERLİ", 5357057379, "GTM", "YARI BAĞIMLI", "YAŞLILIK", 122, 46168684430,"ŞAFAK MAH.1040. SOK. NO7. ÖMERLİ/MARDİN")
Return
::aök,::
...
;;30365211506
::ahöa,:: ;;
myFuncHasta("AHMET ÖNDER", "KOCAKUYU", 5343760971, "GTM", "YARI BAĞIMLI", "ZİHİNSEL ENGELLİ", 29, 30365211506,"KOCAKUYU KÖYÜ ,ÖMERLİ / MARDİN")
Return
::ahök,::
...
::aga,:: ;;
myFuncHasta("ALİ GÜNDÜZ", "ÖMERLİ", 5434471970, "GTM", "YARI BAĞIMLI", "KRONİK BÖBREK YETMEZLİĞİ", 52, 35285047464,"CUMHURİYET Mah, 2081 Sok, daire:2, Dış Kapı No:3 ,ÖMERLİ/MARDİN")
Return
::agk,::
...
Return
::aönk,::
funcKayıt(21215460472, 05416200759)
Return
...
;;35911970432
::aea,:: ;;
myFuncHasta("AYŞE ERDEM", "DEREYANI", 5359843511, "GTM", "YARI BAĞIMLI", "MENTAL VE DAVRANIŞSAL BOZ.", 28, 35911970432,"DEREYANI MAH NO:103 YEŞİLLİ/MARDİN")
Return
::aek,::
...
;;59290247312
::böa,:: ;;
myFuncHasta("BEDRO ÖZELKAN", "KAYAÜSTÜ", 5304678215, "GTM", "YARI BAĞIMLI", " YUMUŞAK DOKU BOZ.", 87, 59290247312,"KAYAÜSTÜ KÖYÜ ÖMERLİ / MARDİN")
Return
::bök,::
funcKayıt(59290247312, 05304678215)
Return
::böi,::BEDRO ÖZELKAN, KAYAÜSTÜ, 05304678215, GTM
;;47314590452
::beaa,:: ;;
myFuncHasta("BEHİYE ACU", "YEŞİLLİ", 5379453058, "GTM", "YARI BAĞIMLI", "PARAPLEJİ", 65, 47314590452,"BAHÇEBAŞI , GÜNEY SK. ACULAR SEMTİ NO:18 YEŞİLLİ / MARDİN")
Return
::beak,::
...
;;66355012020
::cya,:: ;;
myFuncHasta("CUMHUR YİLMAZ", "ÖMERLİ", 5468602756, "GTM", "YARI BAĞIMLI", "KIRIK", 85, 66355012020,"Yeni mah. 3076 sk. (bimin arkasındaki sokak)kapı no 28 ömerli")
Return
::cyk,::
funcKayıt(66355012020, 5468602756)
Return
...
;;29804230154
::eda,:: ;;
myFuncHasta("EMİNE DEMİRCAN", " İKİPINAR", 5325782395, "GTM", "YARI BAĞIMLI", "GENEL TIBBİ MUAYENE", 72, 29804230154," İKİPINAR KÜME EVLERİ, NO:65, ÖMERLİ")
Return
::edk,::
funcKayıt(29804230154, 5325782395)
Return
::edi,::EMİNE DEMİRCAN,  İKİPINAR, 05325782395, GTM
;;36092020596
::emöa,:: ;;
myFuncHasta("EMİNE ÖZÇELİK", "İKİPINAR", 5324778570, "GTM", "YARI BAĞIMLI", "GENEL TIBBİ MUAYENE", 84, 36092020596,"İKİPINAR MAH NO 2 KÖY GİRİŞİ ÖMERLİ / MARDİN")
Return
::emök,::
funcKayıt(36092020596, 5324778570)
Return
::emöi,::EMİNE ÖZÇELİK, İKİPINAR, 05324778570, GTM
;;22799407662
::eta,:: ;;
myFuncHasta("EMİNE TAY", "YEŞİLLİ", 5425768444, "GTM", "YARI BAĞIMLI", "OSTEOPOROZ", 88, 22799407662,"BAHÇEBAŞI MH. HASE HATUN CD. NO:93 YEŞİLLİ/MARDİN")
Return
::etk,::
...
;;19595570348
::eöza,:: ;;
myFuncHasta("EMRAH ÖZER", "ÖMERLİ", 5073795751, "GTM", "YARI BAĞIMLI", "LÖSEMİ", 34, 19595570348,"YENİ MAH. 3073 SK. NO 6 ÖMERLİ")
Return
::eözk,::
...
;;49738565726
::eoa,:: ;;
myFuncHasta("ESMA ORAL", "KAYNAKKAYA", 53102124798, "GTM", "YARI BAĞIMLI", "YAŞLILIK", 122, 49738565726,"KAYNAKKAYA KÖYÜ. NO 11. ÖMERLİ/ MARDİN")
Return
::eok,::
...
::faka,:: ;;
myFuncHasta("FAHREDDİN KOLUMAN", "KAYNAKKAYA", 5312971766, "GTM", "YARI BAĞIMLI", "HEMİPLEJİ", 30, 47725632826,"KAYNAKKAYA Mah,İç Kapı No:1, Dış Kapı No : 23,ÖMERLİ / MARDİN")
Return
::fakk,::
...
::fba,:: ;;
myFuncHasta("FERHAN BALTA", "YEŞİLLİ", 5455036567, "GTM", "YARI BAĞIMLI", "KAS-İSKELET SİSTEMİ HAST.", 75, 15437653026,"GÜL Mah,BAHAR SK. Dış Kapı No : 8, YEŞİLLİ / MARDİN")
Return
::fbk,::
...
::fkua,:: ;;
myFuncHasta("FERHAN KUDAT", "YEŞİLLİ", 5443597550, "GTM", "YARI BAĞIMLI", "ARTROPATİLER", 77, 31043132816,"KARŞIYAKA MAH. DİLEK SOKAK NO:2 ,YEŞİLLİ / MARDİN")
Return
::fkuk,::
funcKayıt(31043132816, 5443597550)
Return
...
::fya,:: ;;
myFuncHasta("FİKRİYE YÜREK", "ÖMERLİ", 5326489135, "GTM", "YARI BAĞIMLI", "YUMUŞAK DOKU BOZUKLUKLARI", 122, 42124819236,"CUMHURİYET MAH. 1. CAD. NO.37 ÖMERLİ / MARDİN")
Return
::fyk,::
...
;;61165128886
::hoa,:: ;;
myFuncHasta("HADRA OLCAY", "YEŞİLLİ", 5448892170, "GTM", "YARI BAĞIMLI", "SVO", 122, 61165128886,"KARŞIYAKA MAH. İSTİKLAL CAD. NO:26 DAİRE:1,YEŞİLLİ / MARDİN")
Return
::hok,::
...
;27224316052
::hga,:: ;;
myFuncHasta("HAMDİYE GÜNEŞ", "ÇINARALTI", 5376747731, "GTM", "YARI BAĞIMLI", " SEREBROVASKÜLER HASTALIK SEKELİ", 60, 27224316052,"ÇINARALTI MAH.No : 111,ÖMERLİ / MARDİN")
Return
::hgk,::
...
;;39634902534
::hala,:: ;;
myFuncHasta("HASAN ALTUNDAĞ", "ÖMERLİ", 5327139447, "GTM", "YARI BAĞIMLI", "YAŞLILIK", 72, 39634902534,"YENİ Mahallesi, 3057Sok.,  Dış Kapı No : 6, ÖMERLİ / MARDİN")
Return
::halk,::
funcKayıt(39634902534, 5327139447)
Return
...
;;19700566778
::hya,:: ;;
myFuncHasta("HASİNE YILMAZ", "ÖMERLİ", 5439474022, "GTM", "YARI BAĞIMLI", "ESANSİYEL HT, DM", 73, 19700566778,"YENİ MAH.ŞEHİT KOMİSER ZÜBEYİR DURGAY SOK. NO:1 ÖMERLİ/MARDİN")
Return
::hyk,::
funcKayıt(19700566778, 5439474022)
Return
::hyi,::HASİNE YILMAZ, ÖMERLİ, 05439474022, GTM

;;35225049640
::hava,:: ;;
myFuncHasta("HAVLİ AKGÜL", "ÖMERLİ", 5353544205, "GTM", "YARI BAĞIMLI", "YUMUŞAK DOKU BOZUKLUKLARI", 122,35225049640,"YENİ MAH. ŞEHİT MEHMET GÜL SK Dış Kapı No : 19B,ÖMERLİ / MARDİN")
Return
::havk,::
...
;;49996556924
::hfa,:: ;;
myFuncHasta("HÜSEYİN FİDAN", "BEŞİKKAYA", 5360205615, "GTM", "YARI BAĞIMLI", "ARTROPATİ", 78, 49996556924,"BEŞİKKAYA KÖYU YUKARI CAMI NO 48 ÖMERLİ ")
Return
::hfk,::
funcKayıt(49996556924, 5360205615)
Return
::hfi,::HÜSEYİN FİDAN, BEŞİKKAYA, 05360205615, GTM
;;61135129806
::hola,:: ;;
myFuncHasta("HÜSEYİN OLCAY", "YEŞİLLİ", 5469477602, "GTM", "YARI BAĞIMLI", "DİŞ ÇÜRÜKLERİ", 122, 61135129806,"KARŞIYAKA Mahallesi, İSTİKLAL CAD. Caddesİ, Dış Kapı No : 30,YEŞİLLİ / MARDİN")
Return
::holk,::
...
;;32387139196
::hüya,:: ;;
myFuncHasta("HÜSEYİN YILDIRIM", "ÖMERLİ", 5347125672, "GTM", "YARI BAĞIMLI", "GENEL TIBBİ MUAYENE", 88, 32387139196,"CUMHURİYET MAH. UZUN SK. No : 14,ÖMERLİ / MARDİN")
Return
::hüyk,::
...
;16388677376
::işa,:: ;;
myFuncHasta("İBRAHİM ŞAHİN", "KAYABALI", 5423649481, "GTM", "YARI BAĞIMLI", "YUMUŞAK DOKU BOZUKLUKLARI", 122, 16388677376,"KAYABALI MAH ÖMERLİ / MARDİN")
Return
::işk,::
...
;;29795174420
::ima,:: ;;
myFuncHasta("İDİ METE", "YEŞİLLİ", 5437602315, "GTM", "YARI BAĞIMLI", "YUMUŞAK DOKU", 122, 29795174420,"BAHÇEBAŞI MAH. , 19 MAYIS CAD. No : 35,YEŞİLLİ / MARDİN")
Return
::imk,::
...
;;34403076614
::kta,:: ;;
myFuncHasta("KAMİLE TEMİZ", "ÖMERLİ", 5360636004, "GTM", "YARI BAĞIMLI", "GENEL TIBBİ MUAYENE", 55, 34403076614,"ŞAFAK Mahallesi, 1042 Sokağı Dış Kapı No :16 ÖMERLİ / MARDİN")
Return
::ktk,::
...
;57358255774
::loa,:: ;;
myFuncHasta("LATİFA ORDU", "YEŞİLLİ", 5367872938, "GTM", "YARI BAĞIMLI", " ALZHEİMER HASTALIĞI", 94, 57358255774,"GÜL MAH. ESKİ MARDİN YOLU NO:28 , YEŞİLLİ / MARDİN")
Return
::lok,::
...
;;48535549946
::maba,:: ;;
myFuncHasta("MEHMET ALİ BEYTAROĞLU", "YEŞİLLİ", 5360320085, "GTM", "YARI BAĞIMLI", "KAS İSKELET SİSTEMİ HASTALIKLARI", 4, 48535549946,"Tepebaşı Mahallesi, 19 Mayıs Caddesi, No: 14/1, YEŞİLLİ / MARDİN")
Return
::mabk,::
...
;;33467108170
::mmta,:: ;;
myFuncHasta("MEHMET MÜHDİ TURAN", "KAYNAKKAYA", 5355201499, "GTM", "YARI BAĞIMLI", " YUMUŞAK DOKU BOZUKLUKLARI", 73, 33467108170,"KAYNAKKAYA MAH ÖMERLİ / MARDİN")
Return
::mmtk,::
funcKayıt(33467108170, 5355201499)
Return
::mmti,::MEHMET MÜHDİ TURAN, KAYNAKKAYA, 05355201499, GTM
;;65560038160
::moa,:: ;;
myFuncHasta("MEHMET ONUR", "ALIÇLI", 5333091672, "GTM", "YARI BAĞIMLI", "KIRIK", 122, 65560038160,"ALIÇLI KME EVLERİ ÖMERLİ")
Return
::mok,::
funcKayıt(65560038160, 5333091672)
Return
::moi,::MEHMET ONUR, ALIÇLI, 05333091672, GTM

;;54676400800
::msba,:: ;;
myFuncHasta("MEHMET SALİH BATUK", "ÖMERLİ", 5383668794, "GTM", "YARI BAĞIMLI", "GENEL TIBBİ MUAYENE", 87, 54676400800,"YENİ MAH. 3033 SK. NO:29 ÖMERLİ / MARDİN")
Return
::msbk,::
...
;;11531839304
::msda,:: ;;
myFuncHasta("MEHMET SALİH DEMİRTAŞ", "KOCASIRT", 5424894814, "GTM", "YARI BAĞIMLI", " YUMUŞAK DOKU BOZ.", 63, 11531839304,"KOCASIRT KÖYÜ / GİRİŞTEKİ SARI EV, ÖMERLİ /MARDİN")
Return
::msdk,::
...
;;20849528794
::mşaa,:: ;;
myFuncHasta("MEHMET ŞERİF ALTUN", "ÖMERLİ", 5366293419, "GTM", "YARI BAĞIMLI", "YAŞLILIK", 122, 20849528794,"YENİ MAH. 2001 SK. ÖMERLİ / MARDİN")
Return
::mşak,::
...
;;21104519946
::mga,:: ;;
myFuncHasta("MESUT GÜMÜŞ", "SALİHKÖY", 5397348360, "GTM", "YARI BAĞIMLI", "MENTAL RETARDASYON", 28, 21104519946,"salih köyü, no :3, ,ÖMERLİ")
Return
::mgk,::
...
::müoa,:: ;;
myFuncHasta("MÜNİRE ORAL", "ANITTEPE", 5302059028, "GTM", "YARI BAĞIMLI", "HİPOTİROİDİZM", 88, 56641335452,"ANITTEPE MAH. KAPI NO:4 ÖMERLİ / MARDİN")
Return
::müok,::
...
;;
::nça,:: ;;
myFuncHasta("NECLA ÇAKAR", "SALİHKÖY", 5348415212, "GTM", "YARI BAĞIMLI", " SEREBROVASKÜLER HASTALIK ", 48, 21698500146,"SALİHKÖY MAH. NO 85 ÖMERLİ / MARDİN")
Return
::nçk,::
...
;;28955258598
::pöa,:: ;;
myFuncHasta("PEYRUZE ÖTER", "ÖMERLİ", 5468034285, "GTM", "YARI BAĞIMLI", "ARTROPATİLER", 78, 28955258598," CUMHURİYET MAH.2081 SK. B-BLOK DAİRE:1 ÖMERLİ / MARDİN")
Return
::pök,::
...
;;40204883740
::rsa,:: ;;
myFuncHasta("RAMAZAN SIĞINÇ", "KAYABALI", 5378532136, "GTM", "YARI BAĞIMLI", "Ortopedik, Zihinsel Engelli", 21, 40204883740,"KAYABALI MAH. (KÖYÜ ) ÖMERLİ / MARDİN")
Return
::rsk,::
...
;;34982057660
::rba,:: ;;
myFuncHasta("REMAZAN BULUT", "KAYNAKKAYA", 5393685401, "GTM", "YARI BAĞIMLI", "SİSTİT", 93, 34982057660,"KAYNAKKAYA KÖYÜ ÖMERLİ")
Return
::rbk,::
...
;;42214816558
::rda,:: ;;
myFuncHasta("REMZİ DOĞAN", "KAYNAKKAYA", 5397659276, "GTM", "YARI BAĞIMLI", "KALP YETMEZLİĞİ", 122, 42214816558,"KAYNAKKAYA KÖYÜ KÜME EVLERİ ÖMERLİ MARDİN")
Return
::rdk,::
...
;;;
::ria,:: ;;
myFuncHasta("RESTEM İLİŞ", "YEŞİLLİ", 5444751146, "GTM", "YARI BAĞIMLI", "GENEL TIBBİ MUAYENE", 90, 14207694092,"GÜL MAH. Mahallesi, MAHİR SK, Dış Kapı No : 15,YEŞİLLİ / MARDİN")
Return
::rik,::
funcKayıt(14207694092, 5444751146)
Return
::rii,::RESTEM İLİŞ, YEŞİLLİ, 05444751146, GTM

;;10724866936
::raa,:: ;;
myFuncHasta("RİFAT ARSLAN", "KAYNAKKAYA", 5373028107, "GTM", "YARI BAĞIMLI", "SEREBRAL PALSİ", 16, 10724866936,"KAYNAKKAYA MAH. İç Kapı No : 1, Dış Kapı No : 116,ÖMERLİ / MARDİN")
Return
::rak,::
...
;;66055021612
::sea,:: ;;
myFuncHasta("SEKİNE EFETÜRK", "ÖMERLİ", 5374239847, "GTM", "YARI BAĞIMLI", "KALP YETMEZLİĞİ", 122, 66055021612,"YENİ MAH. 3025 SOK. NO:10 ÖMERLİ / MARDİN")
Return
::sek,::
...
;;52771408622
::seaa,:: ;;
myFuncHasta("SEMİRE ALİHANOĞLU", "YEŞİLLİ", 5422299647, "GTM", "YARI BAĞIMLI", "MENTAL GERİLİK VE STEROTİPİK HAREKETLERLE BAĞLANTILI OVERAKTİF BOZUKLUK", 41, 52771408622,"TEPEBAŞI MAH. ALİHANOĞLU CAD. YAYLA SOK. NO.8 YEŞİLLİ / MARDİN")
Return
::seak,::
...
;;64573015236
::sema,:: ;;
myFuncHasta("SEMİYE MALKOÇOĞLU", "YEŞİLLİ", 5433444070, "GTM", "YARI BAĞIMLI", "ESANSİYEL HT", 75, 64573015236,"GÜL MAH. MENEKŞE SK. MEHMET İDER APT. NO:1 KAT:1 DAİRE:1 YEŞİLLİ / MARDİN")
Return
::semk,::
...
;;61330179088
::süça,:: ;;
myFuncHasta("SÜLEYMAN ÇİFTÇİ", "ÖMERLİ ", 5364398369, "GTM", "YARI BAĞIMLI", "SİSTİT", 88, 61330179088,"CUMHURİYET MAH HÜRRİYET CAD. NO:65 ÖMERLİ ")
Return
::süçk,::
...
::şeka,:: ;;++
myFuncHasta("ŞEMSİ KAYMAZ", "ANITTEPE", 5326261047, "GTM", "YARI BAĞIMLI", "ESANSİYEL HT", 79, 61480174124,"ANITTEPE Mah, İç Kapı No : 1, Dış Kapı No : 58,ÖMERLİ / MARDİN")
Return
::şekk,::
...
;;19562571354
::tuaa,:: ;;
myFuncHasta("TURKÖ ALTUN", "AKYOKUŞ", 5354727958, "GTM", "YARI BAĞIMLI", "ESANSİYEL HT", 81, 19562571354,"AKYOKUŞ KÖYÜ ÖMERLİ/MARDİN")
Return
::tuak,::
...
;;14357745040
::tüaa,:: ;;
myFuncHasta("TÜRKİYE AYAZ", "KAYABALI", 5366292179, "GTM", "YARI BAĞIMLI", "EPİLEPSİ", 35, 14357745040,"KAYABALI MAH. KAYABALI SK.No : 87,ÖMERLİ / MARDİN")
Return
::tüak,::
...
::zya,:: ;;
myFuncHasta("ZEKİYE YILDIZ", "ÖMERLİ", 5452970790, "GTM", "YARI BAĞIMLI", "DELİRYUM, DEMANS ", 81, 60013222950,"YENİ Mah., 3039 Sokağı, İç Kapı No:1, Dış Kapı No: 44,ÖMERLİ / MARDİN")
Return
::zyk,::
