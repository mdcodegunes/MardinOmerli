...
::aşa,:: ;;
myFuncHasta("ADLE ŞEMİN", "YEŞİLLİ", 5334140326, "GTM", "YARI BAĞIMLI", "BAŞ DÖNMESİ VERTİGO", 112, 24590347970
,"BAHÇEBAŞI MAH. 19 MAYIS CAD. SAĞLAMLAR SOK NO:22 YEŞİLLİ / MARDİN")
Return
::aşk,::
...
::böza,:: ;;
myFuncHasta("BEDRİYE ÖZELKAN", "ÖMERLİ", 5465758181 , "GTM", "YARI BAĞIMLI", "tanı", yaş, 59413243214,"YENİ MAH. Mahallesi, 3001 SOKAK , no :15, ÖMERLİ / MARDİN")
Return
::bözk,::
funcKayıt(59413243214, 5465758181)
Return
...
::ekp,::5452010869
::eka,:: ;;
myFuncHasta("EMİNE KETTE", "YEŞİLLİ",5452010869, "PANSUMAN", "TAM BAĞIMLI", "DM", 80,36092020596,"GÜL MAH. ORDU APT. KAT 6 DAİRE 11 YEŞİLLİ/MARDİN")
return
::ekk,::
funcKayıt(36092020596,5452010869)
Return
...
::eöp,::5468034285
::eöa,:: ;;
myFuncHasta("ESRA ÖTER", "ÖMERLİ",5468034285, "GTM",  "TAM BAĞIMLI", "EPİLEPSİ", 18,47725632826,"YENİ MAH.3076 SK.NO:28 ÖMERLİ MARDİN")
return
;; panates kayıt
::eök,::
funcKayıt(47725632826, 5468034285)
Return
